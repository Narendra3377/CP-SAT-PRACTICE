...
public class Set2A_Question1 extends TestBase {
	...
	public void test() throws Exception {
		...
		for (int i = 0; i < followUs.size(); i++) {
			...
			if (s.contains("fa-pinterest")) {
				WebElement w1 = d.findElement(By.xpath("//div[@class='social links_right']/a[4]"));
		...
		d.findElement(By.xpath("//input[@id='txtsearch']")).sendKeys("Cricket" + Keys.ENTER);
		Thread.sleep(5000);
